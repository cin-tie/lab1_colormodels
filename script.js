// Main application logic with full functionality
class ColorConverter {
    constructor() {
        ...
        this.updateFromRgb(255, 255, 255); // Start with white
    }
    ...
    updateColorFromGradient() {
        try {
            ...
            // Update hue slider to match current hue
    ...
    updateFromRgb(r, g, b) {
        ...
        try {
            ...
            // Update gradient picker position
    ...
    updateColorPreview(hex, r, g, b) {
        ...
        // Add accessibility: change border color based on luminance
...
// Add utility function to global scope for easier debugging
window.clamp = clamp;